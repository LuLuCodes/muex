<template>
  <div class="m-x-switch weui-cell weui-cell_switch">
    ...
    <div class="weui-cell__ft">
      ...
      <div v-if="preventDefault" class="m-x-switch-overlay" @click="onClick"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    labelClass () {
      return {
        'm-cell-justify': this.$parent.labelAlign === 'justify'
      };
    }
  },
  methods: {
