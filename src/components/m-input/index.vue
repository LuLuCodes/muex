<template>
  <div class="mue-m-input weui-cell" :class="{'weui-cell_warn': !valid}">
    ...
    <div class="weui-cell__ft">
      ...
      <icon class="m-input-icon" type="warn" :title="!valid ? firstError : ''"
            v-show="!novalidate && !equalWith && ((touched && !valid && firstError) || (forceShowError && !valid && firstError))"></icon>
      <icon class="m-input-icon" type="warn"
